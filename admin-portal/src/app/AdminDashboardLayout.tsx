...
const navigation = [
  { id: 'overview', href: '/', label: 'Overblik', icon: LayoutDashboard },
  { id: 'users', href: '/users', label: 'Brugerstyring', icon: Users },
  { id: 'surveys', href: '/surveys', label: 'Bruger-Indsigt', icon: MessageSquare },
  { id: 'notifications', href: '/notifications', label: 'Push Beskeder', icon: Bell },
  { id: 'content', href: '/content', label: 'Indhold & AI', icon: BookOpen },
  { id: 'marketing', href: '/marketing', label: 'Marketing & Koder', icon: Sparkles },
  { id: 'emails', href: '/emails', label: 'E-mail Kampagner', icon: Mail },
  { id: 'stats', href: '/stats', label: 'SaaS Statistik', icon: BarChart },
  { id: 'markedsplads', href: '/markedsplads', label: 'Markedsplads', icon: HandHelping },
  { id: 'system', href: '/system', label: 'Aktivitetslog', icon: Database },
];
...
export default function AdminDashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (!isUserLoading && (!user || userProfile?.role !== 'admin')) {
      ...
      window.location.href = 'https://cohero.dk/portal';
    }
             ...
             <div className="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm relative overflow-hidden group">
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between group-hover:translate-x-1 transition-transform">
                    ...
                    <span className="text-[10px] text-slate-400 font-bold">100.0%</span>
                  </div>
                </div>
        ...
        <header className="h-20 flex-shrink-0 flex items-center justify-between px-8 md:px-12 bg-white/70 backdrop-blur-xl z-[40] border-b border-slate-100">
          <div className="flex items-center gap-8">
              <div className="flex flex-col">
                <div className="flex items-center gap-2 text-[10px] font-black uppercase text-slate-400 tracking-widest mb-0.5">
                  <Link href="/" className="hover:text-amber-900 transition-colors">Admin</Link>
          ...
          <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                 ...
                 <div className="w-10 h-10 rounded-xl bg-amber-950 flex items-center justify-center text-amber-400 font-black text-sm shadow-xl shadow-amber-950/20 active:scale-95 transition-all cursor-default">
