                ...
                <section className="lg:col-span-4 space-y-8">
                     <div className="bg-slate-900 text-white p-10 rounded-[3.5rem] shadow-2xl relative overflow-hidden group">
                        <div className="relative z-10">
                           ...
                           <div className="grid gap-3">
                              <Link href="/marketing" className="w-full flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white hover:text-slate-950 transition-all duration-500 group/btn">
                              ...
                              <Link href="/emails" className="w-full flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white hover:text-slate-950 transition-all duration-500 group/btn">
                                 <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center group-hover/btn:bg-slate-50 group-hover/btn:text-slate-900 transition-colors">
                              ...
                              <Link href="/notifications" className="w-full flex items-center justify-between p-5 bg-white/5 border border-white/10 rounded-2xl hover:bg-white hover:text-slate-950 transition-all duration-500 group/btn">
                                 <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center group-hover/btn:bg-slate-50 group-hover/btn:text-slate-900 transition-colors">
                     ...
                     <div className="bg-white p-10 rounded-[3.5rem] border border-slate-100 shadow-sm group hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-700">
                        <div className="flex items-center justify-between mb-8">
                           ...
                           <Link href="/surveys" className="text-xs font-bold text-amber-950 hover:underline">Se alle</Link>
                        </div>
