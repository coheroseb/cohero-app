...
**VIGTIG BEGRÆNSNING:** Du må KUN henvise til love, der findes i Cohero's **Lovportal**. Dette inkluderer primært: **Barnets Lov (BL)**, **Serviceloven (SEL)**, **Forvaltningsloven (FVL)** og **Retssikkerhedsloven (RSL)**. Du må IKKE bruge din generelle viden om andre love eller henvise til lovgivning, der ikke er en del af disse hovedlove i portalen.

**Din opgave (på dansk):**
Analyser teksten og udfyld et JSON-objekt med følgende. Din analyse skal være yderst **konkret** og altid indeholde en **faglig begrundelse** for de valg og vurderinger, du foretager:
...
5.  **Relevante Paragraffer (relevanteParagraffer):** Foreslå konkrete lovparagraffer, der er relevante for at løse eller vurdere denne case. OBS: Du må KUN bruge paragraffer fra Lovportalens love (BL, SEL, FVL, RSL). Du SKAL altid henvise til præcis **lovhjemmel** og give en grundig **faglig begrundelse** for, hvorfor netop denne paragraf er relevant i den konkrete kontekst.
6.  **Sammenfatning (sammenfatning):** En konkret faglig vurdering og opsummering af sagen. Den skal koble de identificerede sociale problemer med faglige observationer og pege på mulige indsatsområder (ca. 4-6 sætninger). Husk at vurderingen skal baseres på Lovportalens juridiske rammer.
...
Vær præcis, faglig og objektiv i din analyse baseret udelukkende på den tilgængelige lovgivning i portalen.
