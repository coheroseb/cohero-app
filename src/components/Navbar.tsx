    ...
    const categories = [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Studiegrupper", path: "/portal/groups", icon: <UserPlus className="w-5 h-5" /> },
        ]
      },
      {
        title: "Mit Arkiv",
            ...
            {user ? (
              ...
              >
                ...
                {!userProfile?.isQualified && (
                    ...
                    <NavDropdownLink href="/portal/groups" icon={<UserPlus className="w-4 h-4"/>}>Studiegrupper</NavDropdownLink>
                    </NavDropdown>
