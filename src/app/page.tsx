       ...
       <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-4 py-4 md:px-12">
         <div className="max-w-7xl mx-auto w-full bg-white/85 backdrop-blur-2xl border border-slate-200/80 rounded-[2rem] h-20 px-6 sm:px-8 flex items-center justify-between shadow-xl shadow-slate-900/5">
           ...
           <div className="hidden md:flex items-center gap-1.5">
              ...
              <a href="#solutions" className="px-4 py-2 text-xs font-extrabold text-slate-500 hover:text-slate-900 uppercase tracking-wider transition-colors">Uddannelser</a>
         ...
         <AnimatePresence>
           {isMobileMenuOpen && (
              ...
              >
                 ...
                 <a href="#solutions" onClick={() => setIsMobileMenuOpen(false)} className="text-sm font-bold text-slate-700 hover:text-slate-900 uppercase tracking-wider py-2">Uddannelser</a>
