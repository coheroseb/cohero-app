        ...
        const categories = [
            {
                ...
                items: [
                    { title: "Simulatoren", desc: "Træn samtaler med AI-borgere", icon: MessageSquare, path: "/portal/simulator", color: "text-indigo-600 bg-indigo-50 border-indigo-200", badge: "UNDER UDVIKLING" },
