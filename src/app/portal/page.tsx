    ...
    <div className="bg-[#FDFBF7] min-h-[100dvh] w-full overflow-x-hidden selection:bg-amber-200 selection:text-amber-950 font-sans pb-12">
      ...
      <main className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-12 gap-10 lg:gap-14">
        ...
        >
          ...
          <div className="w-16 h-16 bg-amber-50 rounded-2xl flex items-center justify-center shrink-0 shadow-inner">
            <AlertTriangle className="w-8 h-8 text-amber-500 animate-pulse" />
          </div>
          
          <div className="flex-1 text-center md:text-left space-y-2">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
              <span className="px-3 py-1 bg-amber-100 text-amber-700 text-[9px] font-black uppercase tracking-[0.2em] rounded-full">Systemopdatering</span>
              <span className="text-slate-300 text-[9px] font-black uppercase tracking-[0.2em]">Fredag - Søndag</span>
            </div>
            <h3 className="text-xl font-black text-slate-900 tracking-tight serif">Vi opdaterer Cohero 🛠️</h3>
            <p className="text-slate-500 text-sm font-medium leading-relaxed">
              Cohero gennemgår en række vigtige opdateringer fra fredag til søndag for at forbedre din oplevelse. Der kan derfor opstå midlertidige problemer eller ustabilitet. Tak for din tålmodighed!
            </p>
          </div>
        </motion.div>
