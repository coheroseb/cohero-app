              ...
              >
                  ...
                  <div className="space-y-3 relative z-10">
                      ...
                      <p className="text-slate-500 leading-relaxed italic text-sm">
                          Træd ind i rollen som socialrådgiver i vores fulde sags-simulator. Real-time hændelser og konsekvenser.
                      </p>
                  </div>

                  <div className="space-y-4 text-left relative z-10 bg-slate-50/50 p-6 rounded-2xl border border-slate-100">
                      {[
                          "Real-time sagsbehandling",
                          "Interaktiv indbakke & kommunikation",
                          "Journalisering & juridisk skøn",
                          "Dybdegående AI-evaluering"
                      ].map((feat, i) => (
